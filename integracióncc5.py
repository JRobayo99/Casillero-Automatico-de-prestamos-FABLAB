...
class EscanerCedulaAntigua:
    ...
    def mostrar_resultados_tkinter(self, data):
        """Muestra los resultados en una ventana de tkinter con botones"""
        ...
        datos_frame.pack(expand=True, fill='both', pady=50)
        ...
        for key, value in data.items():
            if value:  # Solo mostrar si tiene valor
                ...
                label_value = tk.Label(frame_dato, 
                                      ...
                                      fg='white',
                                      anchor='w')
                label_value.pack(side='left', padx=20)
        
        # Frame para botones
        botones_frame = tk.Frame(main_frame, bg='#2E2E2E')
        botones_frame.pack(pady=50)
        ...
        btn_continuar = tk.Button(botones_frame, 
                                  ...
                                  pady=20,
                                  cursor='hand2')
        btn_continuar.pack(side='left', padx=20)
